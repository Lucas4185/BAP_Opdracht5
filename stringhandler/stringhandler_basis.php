...
<div class="wrapper">
    ...
    ?><ul>
        ...
        <li>String 3 is de concatenation van string 1 en string 2:  <?php  $result = $input1 . $input2; echo($result);    ?> </li>
        <li>De lengte van string 3 is:  <?php   echo strlen($result);   ?> </li>
        <li>Zoeken naar spaties. Er zit een spatie op positie  <?php   echo stripos($result," ");    ?> </li>
        <li>Zoeken naar @. Er zit een @ op positie  <?php   echo stripos($result,"@");    ?> </li>
        <li>Zoeken naar "." . Er zit een "." op positie <?php   echo stripos($result,".");   ?> </li>
        <li>Zoek naar substring "PHP" vervang dit door "NodeJS" dd  <?php   echo str_replace("PHP","NodeJS",$result);    ?> </li>
        <li>Wijzig de eerste letter van string 3 naar hoofdletter: <?php   echo ucfirst($result);    ?> </li>
        <li>Alles in hoofdletters:  <?php   echo strtoupper($result);   ?> </li>
    </ul>
    <hr>
    <ol>
